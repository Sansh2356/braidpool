...
impl PeerManager {
    ...
    /// it and return true (the caller should re-initiate IBD). Returns false
    /// for stale or non-IBD failures.
    ...
    /// request (regardless of request id). Used on ConnectionClosed.
